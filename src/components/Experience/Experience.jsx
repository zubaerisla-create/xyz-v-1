...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description: "As a Backend Developer at InnoBugz Solutions, I contributed to the development and deployment of server-side systems and APIs. I worked on building scalable REST APIs, managing server infrastructure, containerizing applications with Docker, and deploying to AWS. I also ensured process reliability using PM2 and collaborated with the team to deliver production-ready backend solutions.",
      skills: ["Node.js", "Express.js", "Docker", "PM2", "AWS", "REST APIs", "Linux", "Git"],
      icon: faReact,
