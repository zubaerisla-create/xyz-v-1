  ...
  <AnimatePresence>
    {isChatOpen && (
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4 overflow-hidden"
        onClick={onClose}
      >
        <motion.div
          ...
          className="w-full max-w-md flex flex-col justify-center max-h-full"
        >
